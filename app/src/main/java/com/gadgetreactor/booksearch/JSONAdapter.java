...
// See if there is a cover ID in the Object
        if (jsonObject.has("cover_i")) {
            ...
            Picasso.with(mContext).load(imageURL).placeholder(R.drawable.bookloading).into(holder.thumbnailImageView);
        } else {

            // If there is no cover ID in the object, use a placeholder
            holder.thumbnailImageView.setImageResource(R.drawable.bookcover);
        }
        ...
        if (publicstatus.equals("true")){
            authorName = authorName + " (Read Now)";
        }
        else if (jsonObject.has("lending_edition_s")) {
            authorName = authorName + " (Loan Avail)";
        }
